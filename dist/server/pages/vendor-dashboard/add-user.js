...
__webpack_require__.d(__webpack_exports__, {
  ...
  "default": () => (/* binding */ next_route_loaderpage_2Fvendor_dashboard_2Fadd_user_preferredRegion_absolutePagePath_private_next_pages_2Fvendor_dashboard_2Fadd_user_2Findex_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_),
...
// NAMESPACE OBJECT: ./pages/vendor-dashboard/add-user/index.js
var add_user_namespaceObject = {};
__webpack_require__.r(add_user_namespaceObject);
__webpack_require__.d(add_user_namespaceObject, {
  "default": () => (add_user)
});
...
// EXTERNAL MODULE: ./common/http.js
var http = __webpack_require__(39681);
;// CONCATENATED MODULE: ./services/user.service.js

class UsersDataService {
    getAll() {
        return http/* default */.Z.get("/users");
    }
    get(id) {
        return http/* default */.Z.get(`/create-user/${id}`);
    }
    create(data) {
        return http/* default */.Z.post("/create-user", data);
    }
    update(id, data) {
        return http/* default */.Z.put(`/update-user/${id}`, data);
    }
    delete(id) {
        return http/* default */.Z.delete(`/remove-user/${id}`);
    }
    deleteAll() {
        return http/* default */.Z.delete(`/user`);
    }
}
/* harmony default export */ const user_service = (new UsersDataService());

// EXTERNAL MODULE: external "next/router"
var router_ = __webpack_require__(71853);
var router_default = /*#__PURE__*/__webpack_require__.n(router_);
;// CONCATENATED MODULE: ./pages/vendor-dashboard/add-user/index.js
...
const index = ()=>{
    ...
    const [userRole, setUserRole] = (0,external_react_.useState)("");
    ...
    (0,external_react_.useEffect)(()=>{
        ...
        //setLoading(false);
            ...
            user_service.get(id).then((response)=>{
    ...
    const add = ()=>{
        ...
        if (id) {
            ...
            user_service.create({
                ...
                router_default().push("/vendor-dashboard/users");
                console.log(response.data);
            }).catch((e)=>{
                console.log(e);
            });
        ...
        if (id) {
            user_service.delete(id).then((response)=>{
                router_default().push("/vendor-dashboard/add-user");
                console.log(response.data);
            }).catch((e)=>{
                console.log(e);
                                    ...
                                    children: /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ jsx_runtime.jsx("div", {
                                                ...
                                                children: "This seciton for adding New User"
                                            })
                                        ]
                                    })
                                }),
...
/* harmony default export */ const add_user = (index);

;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-route-loader/index.js?page=%2Fvendor-dashboard%2Fadd-user&preferredRegion=&absolutePagePath=private-next-pages%2Fvendor-dashboard%2Fadd-user%2Findex.js&absoluteAppPath=private-next-pages%2F_app.js&absoluteDocumentPath=private-next-pages%2F_document.js&middlewareConfigBase64=e30%3D!
        ...
        /* harmony default export */ const next_route_loaderpage_2Fvendor_dashboard_2Fadd_user_preferredRegion_absolutePagePath_private_next_pages_2Fvendor_dashboard_2Fadd_user_2Findex_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_ = ((0,helpers/* hoist */.l)(add_user_namespaceObject, "default"));

        // Re-export methods.
        const getStaticProps = (0,helpers/* hoist */.l)(add_user_namespaceObject, "getStaticProps")
        const getStaticPaths = (0,helpers/* hoist */.l)(add_user_namespaceObject, "getStaticPaths")
        const getServerSideProps = (0,helpers/* hoist */.l)(add_user_namespaceObject, "getServerSideProps")
        const config = (0,helpers/* hoist */.l)(add_user_namespaceObject, "config")
        const reportWebVitals = (0,helpers/* hoist */.l)(add_user_namespaceObject, "reportWebVitals")
        

        // Re-export legacy methods.
        const unstable_getStaticProps = (0,helpers/* hoist */.l)(add_user_namespaceObject, "unstable_getStaticProps")
        const unstable_getStaticPaths = (0,helpers/* hoist */.l)(add_user_namespaceObject, "unstable_getStaticPaths")
        const unstable_getStaticParams = (0,helpers/* hoist */.l)(add_user_namespaceObject, "unstable_getStaticParams")
        const unstable_getServerProps = (0,helpers/* hoist */.l)(add_user_namespaceObject, "unstable_getServerProps")
        const unstable_getServerSideProps = (0,helpers/* hoist */.l)(add_user_namespaceObject, "unstable_getServerSideProps")

        // Create and export the route module that will be consumed.
        const options = {"definition":{"kind":"PAGES","page":"/vendor-dashboard/add-user","pathname":"/vendor-dashboard/add-user","bundlePath":"","filename":""}}
        const routeModule = new (module_default())({
          ...
          userland: add_user_namespaceObject,
        })
...
var __webpack_exports__ = __webpack_require__.X(0, [6678,8719,5675,1664,330,8443,3828,6746,9918,1920,9677], () => (__webpack_exec__(81473)));
