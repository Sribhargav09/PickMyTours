...
__webpack_require__.d(__webpack_exports__, {
  ...
  "default": () => (/* binding */ next_route_loaderpage_2Fvendor_dashboard_2Fadd_location_preferredRegion_absolutePagePath_private_next_pages_2Fvendor_dashboard_2Fadd_location_2Findex_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_),
...
// NAMESPACE OBJECT: ./pages/vendor-dashboard/add-location/index.js
var add_location_namespaceObject = {};
__webpack_require__.r(add_location_namespaceObject);
__webpack_require__.d(add_location_namespaceObject, {
  "default": () => (add_location)
});
...
;// CONCATENATED MODULE: ./pages/vendor-dashboard/add-location/index.js
...
const index = ()=>{
    ...
    const validateForm = ()=>{
        if (name.length == 0) {
            ...
            if (id) {
                location_service/* default */.Z.update(id, {
                    name,
                    description,
                    photo
                }).then((response)=>{
                    router_default().push("/vendor-dashboard/locations");
                    console.log(response.data);
                }).catch((e)=>{
                    console.log(e);
                });
            } else {
                location_service/* default */.Z.create({
                    name,
                    description,
                    photo
                }).then((response)=>{
...
/* harmony default export */ const add_location = (index);

;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-route-loader/index.js?page=%2Fvendor-dashboard%2Fadd-location&preferredRegion=&absolutePagePath=private-next-pages%2Fvendor-dashboard%2Fadd-location%2Findex.js&absoluteAppPath=private-next-pages%2F_app.js&absoluteDocumentPath=private-next-pages%2F_document.js&middlewareConfigBase64=e30%3D!
        ...
        /* harmony default export */ const next_route_loaderpage_2Fvendor_dashboard_2Fadd_location_preferredRegion_absolutePagePath_private_next_pages_2Fvendor_dashboard_2Fadd_location_2Findex_js_absoluteAppPath_private_next_pages_2F_app_js_absoluteDocumentPath_private_next_pages_2F_document_js_middlewareConfigBase64_e30_3D_ = ((0,helpers/* hoist */.l)(add_location_namespaceObject, "default"));

        // Re-export methods.
        const getStaticProps = (0,helpers/* hoist */.l)(add_location_namespaceObject, "getStaticProps")
        const getStaticPaths = (0,helpers/* hoist */.l)(add_location_namespaceObject, "getStaticPaths")
        const getServerSideProps = (0,helpers/* hoist */.l)(add_location_namespaceObject, "getServerSideProps")
        const config = (0,helpers/* hoist */.l)(add_location_namespaceObject, "config")
        const reportWebVitals = (0,helpers/* hoist */.l)(add_location_namespaceObject, "reportWebVitals")
        

        // Re-export legacy methods.
        const unstable_getStaticProps = (0,helpers/* hoist */.l)(add_location_namespaceObject, "unstable_getStaticProps")
        const unstable_getStaticPaths = (0,helpers/* hoist */.l)(add_location_namespaceObject, "unstable_getStaticPaths")
        const unstable_getStaticParams = (0,helpers/* hoist */.l)(add_location_namespaceObject, "unstable_getStaticParams")
        const unstable_getServerProps = (0,helpers/* hoist */.l)(add_location_namespaceObject, "unstable_getServerProps")
        const unstable_getServerSideProps = (0,helpers/* hoist */.l)(add_location_namespaceObject, "unstable_getServerSideProps")

        // Create and export the route module that will be consumed.
        const options = {"definition":{"kind":"PAGES","page":"/vendor-dashboard/add-location","pathname":"/vendor-dashboard/add-location","bundlePath":"","filename":""}}
        const routeModule = new (module_default())({
          ...
          userland: add_location_namespaceObject,
        })
...
var __webpack_exports__ = __webpack_require__.X(0, [6678,8719,5675,1664,330,8443,3828,6746,9918,1920,9677], () => (__webpack_exec__(32641)));
