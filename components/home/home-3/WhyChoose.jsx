...
const WhyChoose = () => {
  ...
  return (
    <>
      <div className="row why-us descktopScreen">
        <div class="column">
          <img src="/img/banners/tour.png" />
        </div>
        <div class="column pt-40 pl-40 pr-40">
          <h2>Why Choose Us?</h2>
          <div class="text pt-20">At PickMyTour, we understand that travel is not just about reaching a destination; it's about the journey itself. 
          ...
          Choose PickMyTour and embark on a voyage where your dreams are our destination.</div>
          <p class="text">We first gained recognition by <b>StartUp India</b> back in 2019, followed by being awarded the <b>Travelers choice award</b> in 2020 by <b>Trip Advisor.</b> </p>
        </div>
