...
const Share = ({ title, shareUrl }) => {
    ...
    <>
            ...
            <div class="py-10">
                ...
                <div class="py-20 d-flex">
                    <span class="border-light rounded-4 col-8">
                        <input type="text" value={shareUrl} />
                    </span>
                    <button onClick={() => {navigator.clipboard.writeText(shareUrl); setCopy('Copied')}}
class="ml-10 button -dark-1 bg-blue-1 text-white px-20 py-10">{copy}</button>
                </div>
                
            </div>

            
            <div class="py-20">Or share on</div>
                ...
                <div className="shareButtons">
                    ...
                    <div className="Demo__some-network">
                        <PinterestShareButton
                            ...
                            media={'https://pickmytours.com/img/general/logo.png'}
                            className="Demo__some-network__share-button"
                        >
                    ...
                    <div className="Demo__some-network">
                        <VKShareButton
                            url={shareUrl}
                            image={'https://pickmytours.com/img/general/logo.png'}
                            className="Demo__some-network__share-button"
                        >
